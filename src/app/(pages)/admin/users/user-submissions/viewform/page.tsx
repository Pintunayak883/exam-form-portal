...
export default function ViewPage() {
  ...
  const sendRemark = () => {
    ...
    const phoneRaw = formData.phone.replace(/\D/g, ""); // Remove non-digits
    if (!/^\d{10}$/.test(phoneRaw)) {
      toast.error("Invalid phone number format", { position: "top-right" });
      return;
    }

    // Format phone number (prepend +91)
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="print-container" ref={pdfRef}>
          {/* Appointment Letter Section (StarParth) */}
          ...
          {/* Appointment Letter Section (Netparam) */}
          <div className="preview-section">
            <div className="flex justify-between mb-4 w-full">
              <img
                src="/netparam-logo.png"
