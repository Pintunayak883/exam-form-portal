    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="print-container" ref={pdfRef}>
          {/* Aapka baaki preview sections ka code same rahega */}
          {/* Yahan aap apne Appointment Letter, Self-Declaration, Undertaking, aur Payout sections ka code daal sakte hain */}
        </div>
